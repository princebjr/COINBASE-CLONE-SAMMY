...
<<<<<<< HEAD
            ...
            <button
              type="submit"
              disabled={loading}
              style={{ width: '100%', background: loading ? '#93A8F4' : '#1652F0', color: '#fff', fontWeight: '700', fontSize: '1rem', padding: '14px', borderRadius: '40px', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', marginBottom: '20px', letterSpacing: '0.01em' }}
              onMouseEnter={e => { if (!loading) e.currentTarget.style.background = '#0F47D4'; }}
...
<<<<<<< HEAD
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '28px' }}>
            <button type="button" style={{ display: 'flex', width: '100%', alignItems: 'center', justifyContent: 'center', gap: '12px', background: '#F3F4F6', border: '1px solid #D1D5DB', borderRadius: '40px', padding: '13px', color: '#000', fontWeight: '700', fontSize: '1rem', cursor: 'pointer' }}
...
<<<<<<< HEAD
            <Link to="/signup" style={{ color: '#1652F0', fontWeight: '600', textDecoration: 'none' }}>Sign up</Link>
          </p>
=======
